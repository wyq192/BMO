...
//        <o6>  PLL Clock Source Divider (SRC)
//                <0=> 1
//                <1=> 2
...
#define WAIT_STATE        (9)     /*!< 0: 0WS,  1: 1WS,  2: 2WS,                                                    9: AUTO   */
#define CACHE_ENABLE      (1)     /*!< 0: DISABLE,  1: ENABLE                                                                 */
...
//  while (HT_PWRCU->TEST != 0x27);                               /* wait for VDD power domain register ready */
  ...
  /* Cache configuration                                                                                    */
#if (CACHE_ENABLE == 1)
  SetBit_BB((u32)(&HT_FLASH->CCR), 0);                          /* 0: cache disable, 1: cache enable        */
  while (HT_FLASH->SR != 0x00000012);
#else
  ResetBit_BB((u32)(&HT_FLASH->CCR), 0);                        /* 0: cache disable, 1: cache enable        */
