...
#if (HTCFG_STACK_USAGE_ANALYSIS == 1)
u32 _StatckLimit = HT_SRAM_BASE + LIBCFG_RAM_SIZE;
#if defined (__CC_ARM)
/*********************************************************************************************************//**
  * @brief  Stack Usage Analysis Init
  * @retval None
  ***********************************************************************************************************/
__ASM void StackUsageAnalysisInit(void)
{
  extern _StatckLimit;
...
/*********************************************************************************************************//**
  ...
  * @retval None
  ***********************************************************************************************************/
__attribute__((noinline)) void StackUsageAnalysisInit(void)
{
  __ASM volatile ("  MOVS R0, #0");
  __ASM volatile ("  LDR R0, [r0]");
  __ASM volatile ("  LDR R1, =_StatckLimit");
